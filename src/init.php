...
if($_GET['page'] != "accueil" && $_GET['page'] != "login"  && $_GET['page'] != "espaceClient" && $_GET['page'] != "mes_comptes" && $_GET['page'] != "mes_transactions" && $_GET['page'] != "mes_virements" && $roleadmin['role'] != 1000 && $roleadmin['role'] != 200){
    header('Location: /?page=accueil');
    exit();
}
